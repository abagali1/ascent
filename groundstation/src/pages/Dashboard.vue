  ...
  <div>
    ...
    <div class="row lshift">
      <div class="col-lg-3" :class="{'text-right': isRTL}">
        <card type="chart" class="shrink">
          <template slot="header">
            <h3 class="card-title">Estimated Altitude (m)</h3>
            <h5 class="card-category">Current Altitude - 5 m</h5>
          </template>
        ...
        <card type="chart" class="shrink" style="margin-top: -1em;">
          <template slot="header">
            ...
            <h5 class="card-category">Current Velocity - 0.23 ms^-1</h5>
          </template>
          <div class="chart-area">
            <line-chart style="height: 100%"
                        chart-id="purple-line-chart"
      ...
      <div class="col-lg-3" :class="{'text-right': isRTL}">
        <card type="chart" class="shrink">
          <template slot="header">
            <h3 class="card-title">Yaw (degrees)</h3>
            <h5 class="card-category">Current Yaw - 0.23 deg</h5>
          </template>
          <div class="chart-area">
            <line-chart style="height: 100%"
                        chart-id="purple-line-chart"
      ...
      <div class="col-lg-3" :class="{'text-right': isRTL}">
        <card type="chart" class="shrink">
          <template slot="header">
            <h3 class="card-title">Pitch (degrees)</h3>
            <h5 class="card-category">Current Pitch - 0.23 deg</h5>
          </template>
          <div class="chart-area">
            <line-chart style="height: 100%"
                        chart-id="purple-line-chart"
      ...
      <div class="col-lg-3" :class="{'text-right': isRTL}">
        <card type="chart" class="shrink">
          <template slot="header">
             <h3 class="card-title">Roll (degrees)</h3>
            <h5 class="card-category">Current Roll - 0.23 deg</h5>
          </template>
          <div class="chart-area">
            <line-chart style="height: 100%"
        ...
        purpleLineChart: {
          ...
          chartData: {
            ...
            }, 
            {
              ...
              pointHoverBorderWidth: 15,
              pointRadius: 4,
              data: [30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30],
            }
            ]
          },
